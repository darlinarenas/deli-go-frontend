...
async function sw(){if(!('serviceWorker'in navigator))throw Error('Este navegador no admite la instalación de BHUZ.');const reg=await navigator.serviceWorker.register('/service-worker.js?v=20260719-8',{updateViaCache:'none'});await reg.update().catch(()=>{});return navigator.serviceWorker.ready}
